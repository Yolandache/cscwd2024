...
# 将两个分类随机抽样成1：1的比例
data = pd.read_csv(r"D:\total\csv\test\content.csv")
...
data_train.to_csv(r"D:\total\csv\test\content.csv", index=False)
...
edges_unordered.to_csv(r"D:\total\csv\test\adjacency.csv", index=False)
