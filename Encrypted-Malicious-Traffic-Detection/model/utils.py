...
def load_data(path='D:/Encrypted-Malicious-Traffic-Detection/total/csv/test/', dataset="GCN"):
    ''' Load  dataset '''
    ...
    print(len(in_bytes_deal),len(out_bytes_deal))
...
def pinggu(output, labels):
    ...
    pre = precision_score(labels, output)
